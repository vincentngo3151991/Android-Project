package thunderiven.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        assertTrue("Error: Fail to insert LocationTable",insertLocation()!=-1);
    }
    ...
    public void testWeatherTable() {
        ...
        long rowId=db.insert(WeatherContract.WeatherEntry.TABLE_NAME,null,weatherContentValue);
        assertTrue("Error: Failed to insert weatherContentValue to database",rowId!=-1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: table not match",c,weatherContentValue);
    ...
    public long insertLocation() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("LocationTable not match",c,contentValues);
